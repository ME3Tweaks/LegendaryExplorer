...
namespace ME3Explorer.Dialogue_Editor
{
    ...
    public sealed class DStart : DBox
    {
        ...
        public int Order;
        private readonly DialogueEditorWPF Editor;
    ...
    public class DiagNode : DBox
    {
        ...
        public DiagNode(DialogueEditorWPF editor, DialogueNodeExtended node, float x, float y, ConvGraphEditor ConvGraphEditor)
            : base(ConvGraphEditor)
        {
            Editor = editor;
            Node = node;
    ...
    {
        public DiagNodeEntry(DialogueEditorWPF editor, DialogueNodeExtended node, float x, float y, ConvGraphEditor ConvGraphEditor)
    ...
    public sealed class DiagNodeReply : DiagNode
    {
        ...
        public DiagNodeReply(DialogueEditorWPF editor, DialogueNodeExtended node, float x, float y, ConvGraphEditor ConvGraphEditor)
            : base(editor, node, x, y, ConvGraphEditor)
        {
