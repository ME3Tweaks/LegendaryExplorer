...
{
    public class HuffmanGraph : PCanvas
    {
        /// <summary>
        ...
        /// </summary>
        public HuffmanGraph() : this(DEFAULT_WIDTH, DEFAULT_HEIGHT) { }
        public PLayer nodeLayer;
        public PLayer edgeLayer;
        public PLayer backLayer;
        public HuffmanGraph(int width, int height)
        {
            InitializeComponent();
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            {
                string msg = "Updating, please wait............"; //without multithread this does nothing.
