...
namespace ME3Explorer
{
    ...
    public partial class KFreonTPFTools3 : Form
    {
        ...
        private void extractAllToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                fbd.Description = "Select a folder containing .tpf files for bulk extraction.";
            ...
            var tpfFiles = Directory.GetFiles(outputPath, "*.tpf", SearchOption.AllDirectories);
            foreach (var tpf in tpfFiles)
            {
                LoadTPF(tpf);
                Extractor(outputPath);
                ClearAllFilesButton.PerformClick();
            }
        }
