...
namespace ME3Explorer.Scene3D
{
    ...
    public class Effect<ConstantBufferData, Vertex> : IDisposable where ConstantBufferData : struct where Vertex : VertexBase, new()
    {
        ...
        public VertexShader VertexShader { get; private set; } = null;
        public PixelShader PixelShader { get; private set; } = null;
        public SharpDX.Direct3D11.Buffer ConstantBuffer { get; private set; } = null;
        public InputLayout InputLayout { get; private set; } = null;
