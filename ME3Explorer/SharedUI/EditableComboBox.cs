...
{
    public class EditableComboBox : TextBlock
    {
        ...
        private EditableComboBoxAdorner _adorner;

        // Using a DependencyProperty as the backing store for IsInEditMode.  This enables animation, styling, binding, etc...
        public static readonly DependencyProperty IsInEditModeProperty =
            DependencyProperty.Register("IsInEditMode", typeof(bool), typeof(EditableComboBox), new UIPropertyMetadata(false, IsInEditModeUpdate));
        ...
        {
            EditableComboBox textBlock = obj as EditableComboBox;
            if (null != textBlock)
            {
                ...
                if (textBlock.IsInEditMode)
                {
                    ...
                    {
                        textBlock._adorner = new EditableComboBoxAdorner(textBlock);
                ...
                else
                {
                    ...
                    if (adorners != null)
                    {
                        ...
                        {
                            if (adorner is EditableComboBoxAdorner)
                            {
        ...
        public static readonly DependencyProperty MaxLengthProperty =
            DependencyProperty.Register("MaxLength", typeof(int), typeof(EditableComboBox), new UIPropertyMetadata(0));
