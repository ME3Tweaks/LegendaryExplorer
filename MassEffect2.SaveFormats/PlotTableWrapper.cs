...
namespace MassEffect2.SaveFormats
{
	...
	public class PlotTableWrapper : INotifyPropertyChanged, ISerializable
	{
		...
		private const int ParagonPointsId = 2;//10159;

		private const int RenegadePointsId = 3;//10160;

		//private const int ReputationId = 10297;

		private const int ExtraMedigelId = 11;//10300;

		//private const int ReputationPointsId = 10380;

		//private const int IsMe2ImportId = 21554;

		private const int IsMe1ImportId = 2279;//22226;
