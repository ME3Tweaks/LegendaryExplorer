...
namespace Gammtek.Conduit.Helpers
{
	...
	public static class ObjectHelper
	{
		...
		///     <list type="bullet">
		///         <item>
		///             <description>Both values are <c>null</c>.</description>
		///         </item>
		///         <item>
		///             <description>Both values have the same reference, checked by <see cref="object.ReferenceEquals" />.</description>
		///         </item>
		///         <item>
		///             <description>Both values are value types and have the same value.</description>
		///         </item>
		///         <item>
		///             <description>Both values are string type and have the same value.</description>
		///         </item>
		///     </list>
		/// </summary>
		/// <param name="object1">The first object.</param>
