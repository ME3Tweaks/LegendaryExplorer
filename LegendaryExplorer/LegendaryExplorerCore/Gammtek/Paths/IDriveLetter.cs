...
namespace LegendaryExplorerCore.Gammtek.Paths
{
	...
	public interface IDriveLetter
	{
		...
		/// <seealso cref="P:LegendaryExplorerCore.Gammtek.Paths.IAbsoluteDirectoryPath.DirectoryInfo" />
		/// <seealso cref="P:LegendaryExplorerCore.Gammtek.Paths.IAbsoluteFilePath.FileInfo" />
