...
namespace LegendaryExplorerCore.Gammtek.Helpers
{
	/// <summary>
	...
	public static class BindingFlagsHelper
	{
		...
		///     A value representing whether the hierarchy should be flattened. Corresponds with
		///     <see cref="BindingFlags.FlattenHierarchy" />.
		/// </param>
		...
		public static BindingFlags GetFinalBindingFlags(bool flattenHierarchy, bool allowStaticMembers, bool? allowNonPublicMembers = null)
		{
			...
			{
				bindingFlags = allowNonPublicMembers.Value
					? Enum<BindingFlags>.Flags.SetFlag(bindingFlags, BindingFlags.NonPublic)
					: Enum<BindingFlags>.Flags.ClearFlag(bindingFlags, BindingFlags.NonPublic);
			}
