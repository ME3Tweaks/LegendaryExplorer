...
namespace LegendaryExplorerCore.GameFilesystem
{
    public static class LE2Directory
    {
        ...
        public static readonly string[] BasegameTFCs =
        {
            ...
            "Textures0_DLC_UNC_Patch01",
            "Textures1_DLC_UNC_Patch01",
            "Textures2_DLC_UNC_Patch01",
            "Textures3_DLC_UNC_Patch01",
            "Textures4_DLC_UNC_Patch01",
            "Textures5_DLC_UNC_Patch01",
            "Textures6_DLC_UNC_Patch01",
            "Textures7_DLC_UNC_Patch01",
