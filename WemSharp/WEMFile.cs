...
namespace WEMSharp
{
    public class WEMFile
    {
        ...
        {
            internalGenerateOGG(fileLocation, codebooksLocation, inlineCodebooks, fullSetup).Close();
        }

        public Stream GenerateOGGStream(string fileLocation, string codebooksLocation, bool inlineCodebooks, bool fullSetup)
        {
            return internalGenerateOGG(null, codebooksLocation, inlineCodebooks, fullSetup);
        }

        private Stream internalGenerateOGG(string fileLocation, string codebooksLocation, bool inlineCodebooks, bool fullSetup)
        {
            ...
            {
                ogg = new OggStream(File.Create(fileLocation));
            }
            else
            {
                ogg = new OggStream(new MemoryStream());
            }
