...
namespace MassEffect.Windows.Markup
{
    ...
    /// <remarks>
    ///     <para>
    ///         The <c>TypeConverter</c> class can be used to attempt to convert values between a <see cref="SourceType" /> and
    ///         <see cref="TargetType" />.
    ///         The <see cref="Convert" /> method will attempt to convert values to the <see cref="TargetType" />, whilst the
    ///         <see cref="ConvertBack" />
    ///         method will attempt to convert values to the <see cref="SourceType" />.
    ///     </para>
    ///     <para>
    ///         This class attempts to convert values by way of the <see cref="IConvertible" /> interface. However, if the value being converted
    ///         does not
    ///         implement <see cref="IConvertible" />, an attempt is made to convert via a suitable
    ...
    public class TypeConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            if (TargetType == null)
            {
                throw new InvalidOperationException("NoTargetType");
            }
        ...
        public object ConvertBack(object value, Type targetType, object parameter, CultureInfo culture)
        {
            if (TargetType == null)
            {
                throw new InvalidOperationException("NoSourceType");
            }
