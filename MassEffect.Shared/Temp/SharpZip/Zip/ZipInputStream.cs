...
#if !NETCF_1_0
#endif
using MassEffect.Shared.Temp.SharpZip.Checksums;
using MassEffect.Shared.Temp.SharpZip.Encryption;
using MassEffect.Shared.Temp.SharpZip.Zip.Compression;
using MassEffect.Shared.Temp.SharpZip.Zip.Compression.Streams;

namespace MassEffect.Shared.Temp.SharpZip.Zip
{
	/// <summary>
