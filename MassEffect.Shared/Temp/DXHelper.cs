...
using MassEffect.Shared.Temp.UnrealClasses;
...
namespace MassEffect.Shared.Temp
{
    public static class DXHelper
    {
        ...
        public static void SetupEnvironment()
        {
            ...
            DefaultTex = TextureLoader.FromStream(device, new MemoryStream(MassEffect.Shared.Properties.Resources.Default));
			SelectTex = TextureLoader.FromStream(device, new MemoryStream(MassEffect.Shared.Properties.Resources.Select));
        }
