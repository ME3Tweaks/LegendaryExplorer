...
namespace MassEffect.Shared.Temp
{
    public static class DebugLog
    {
        public static RichTextBox rtb;
        public static FileStream fs = new FileStream(Path.GetDirectoryName(Application.ExecutablePath) + "\\DebugLog-" + DateTime.Now.ToString("yyyy.MM.dd-HH.mm.ss") + ".txt", FileMode.Create, FileAccess.Write);
