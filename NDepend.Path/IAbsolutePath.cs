...
namespace NDepend.Path
{
	...
	public interface IAbsolutePath : IPath
	{
		...
		///     is thrown if this absolute path <see cref="Kind" /> is different than
		///     <see cref="AbsolutePathKind" />.<see cref="AbsolutePathKind.DriveLetter" />.
		/// </exception>
		...
		/// <exception cref="System.InvalidOperationException">
		///     is thrown if this absolute path <see cref="Kind" /> is different than
		///     <see cref="AbsolutePathKind" />.<see cref="AbsolutePathKind.UNC" />.
		/// </exception>
	...
	internal abstract class AbsolutePathContract : IAbsolutePath
	{
		...
		public bool CanGetRelativePathFrom(IAbsoluteDirectoryPath pivotDirectory, out string failureMessage)
		{
			Contract.Requires(pivotDirectory != null, "pivotDirectory must not be null");
			throw new NotImplementedException();
		}
		...
		{
			Contract.Requires(otherAbsolutePath != null, "pathAbsoluteOther must not be null");
			throw new NotImplementedException();
		}
