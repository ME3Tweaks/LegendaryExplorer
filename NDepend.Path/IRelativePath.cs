...
namespace NDepend.Path
{
	...
	internal abstract class RelativePathContract : IRelativePath
	{
		...
		public bool CanGetAbsolutePathFrom(IAbsoluteDirectoryPath pivotDirectory, out string failureMessage)
		{
			Contract.Requires(pivotDirectory != null, "pivotDirectory must not be null");
			throw new NotImplementedException();
		}
