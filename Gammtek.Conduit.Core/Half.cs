...
namespace Gammtek.Conduit
{
	...
	///     data. The result of providing a value that is not a floating-point number (such as infinity or NaN) to such a command is
	///     unspecified, but must not lead to GL interruption or termination. Providing a denormalized number or negative zero to GL must
	...
	public struct Half : ISerializable, IComparable<Half>, IFormattable, IEquatable<Half>
	{
		...
		private static UInt16 SingleToHalf(Int32 si32)
		{
