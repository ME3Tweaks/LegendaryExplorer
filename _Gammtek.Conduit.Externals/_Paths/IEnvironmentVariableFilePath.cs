namespace Gammtek.Conduit.Paths
{
	...
	public interface IEnvironmentVariableFilePath : IFilePath, IEnvironmentVariablePath
	{
		...
		new IEnvironmentVariableDirectoryPath GetSisterDirectoryWithName(string directoryName);
		...
		new IEnvironmentVariableFilePath GetSisterFileWithName(string fileName);
