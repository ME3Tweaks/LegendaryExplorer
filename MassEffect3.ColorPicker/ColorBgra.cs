...
namespace MassEffect3.ColorPicker
{
	...
	public struct ColorBgra
	{
		...
		public byte B
		{
			get { return (byte) ((Bgra & 0x000000FFu) >> 0); }
		}

		public byte G
		{
			get { return (byte) ((Bgra & 0x0000FF00u) >> 8); }
		}

		public byte R
		{
			get { return (byte) ((Bgra & 0x00FF0000u) >> 16); }
		}

		public byte A
		{
			get { return (byte) ((Bgra & 0xFF000000u) >> 24); }
		}
		...
		{
			var rgbNumber = (R << 16) | (G << 8) | B;
			var colorString = Convert.ToString(rgbNumber, 16);
			...
			var alphaString = Convert.ToString(A, 16);
		...
		{
			const uint ww = 32768;
			var af = (c1.A * w1) + (c2.A * w2) + (c3.A * w3) + (c4.A * w4);
			var a = (af + ww) >> 16;
